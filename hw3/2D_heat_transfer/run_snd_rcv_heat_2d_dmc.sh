...
if test -f "./heat_2d_snd_rcv_MPI.cpp" 
  then
  echo "Recompiling Source file heat_2d_snd_rcv_MPI.cpp"
  echo "mpic++ heat_2d_snd_rcv_MPI.cpp -o heat_2d_snd_rcv_MPI -std=c++11 -O3"
  module load openmpi
  mpic++ heat_2d_snd_rcv_MPI.cpp -o heat_2d_snd_rcv_MPI -std=c++11 -O3
  echo "complete!"
  # copy mpi scripts to the current directory
  echo "Copying openmpi script files to current directory"
  cp /home/shared/wells_class/MPI_Examples/2D_heat_transfer/.snd_rcv_scripts/openmpi/* . 
else
  if test -f "./heat_2d_snd_rcv_MPI2.cpp" 
    then
    echo "Recompiling Source file heat_2d_snd_rcv_MPI2.cpp"
    echo "mpic++ heat_2d_snd_rcv_MPI2.cpp -o heat_2d_snd_rcv_MPI -std=c++11 -O3"
    module load mpich
    mpic++ heat_2d_snd_rcv_MPI2.cpp -o heat_2d_snd_rcv_MPI -std=c++11 -O3
    echo "complete!"
    # copy mpi scripts to the current directory
    echo "Copying mpich script files to current directory"
    cp /home/shared/wells_class/MPI_Examples/2D_heat_transfer/.snd_rcv_scripts/mpich/* . 
  else
    if test -f "./heat_2d_snd_rcv_MPI.c" 
      then
      echo "Recompiling Source file heat_2d_snd_rcv_MPI.c"
      echo "mpicc heat_2d_snd_rcv_MPI.c -o heat_2d_snd_rcv_MPI -O3"
      module load openmpi
      mpicc heat_2d_snd_rcv_MPI.c -o heat_2d_snd_rcv_MPI -O3
      echo "complete!"
      # copy mpi scripts to the current directory
      echo "Copying openmpi script files to current directory"
      cp /home/shared/wells_class/MPI_Examples/2D_heat_transfer/.snd_rcv_scripts/openmpi/* . 
      ...
      echo "Looking for file heat_2d_snd_rcv_MPI.cpp, heat_2d_snd_rcv_MPI2.cpp"
      echo "or heat_2d_snd_rcv_MPI.c to compile"
      exit
    fi  
  fi  
fi  
...
cp /home/shared/wells_class/MPI_Examples/2D_heat_transfer/.snd_rcv_scripts/general/* . 
...
# 1 MPI Process Run
# Number of Nodes: 1 
# Script File: heat_2d_snd_rcv_MPI_1_tm.txt
echo -e "Scheduling 1 MPI Process Job on the DMC\n"
echo -e "class\n1\n01:00:00\n32gb\n\n"$constraint"\n" | run_script_mpi heat_2d_snd_rcv_MPI_1_dmc.sh >heat_2d_snd_rcv_MPI_1_tm.txt
#
# 2 MPI Process Run
# Number of Nodes: 2 
# Script File: heat_2d_snd_rcv_MPI_2_tm.txt
echo -e "Scheduling 2 MPI Process Job on the DMC\n"
# DMC Node Architecture Constraint: first argument
echo -e "class\n2\n01:00:00\n32gb\n\n"$constraint"\n" | run_script_mpi heat_2d_snd_rcv_MPI_2_dmc.sh >heat_2d_snd_rcv_MPI_2_tm.txt
#
# 4 MPI Process Run
# Number of Nodes: 4 
# Script File: heat_2d_snd_rcv_MPI_4_tm.txt
echo -e "Scheduling 4 MPI Process Job on the DMC\n"
echo -e "class\n4\n01:00:00\n32gb\n\n"$constraint"\n" | run_script_mpi heat_2d_snd_rcv_MPI_4_dmc.sh >heat_2d_snd_rcv_MPI_4_tm.txt
#
# 8 MPI Process Run
# Number of Nodes: 8 
# Script File: heat_2d_snd_rcv_MPI_8_tm.txt
echo -e "Scheduling 8 MPI Process Job on the DMC\n"
echo -e "class\n8\n01:00:00\n32gb\n\n"$constraint"\n" | run_script_mpi heat_2d_snd_rcv_MPI_8_dmc.sh >heat_2d_snd_rcv_MPI_8_tm.txt
#
# 16 MPI Process Run
# Number of Nodes: 16 
# Script File: heat_2d_snd_rcv_MPI_16_tm.txt
echo -e "Scheduling 16 MPI Process Job on the DMC\n"
echo -e "class\n16\n01:00:00\n32gb\n\n"$constraint"\n" | run_script_mpi heat_2d_snd_rcv_MPI_16_dmc.sh >heat_2d_snd_rcv_MPI_16_tm.txt
